...
const meraRoutes = require('./backend/modules/mera/mera.routes');
const meraVerimAyarlariRoutes = require('./backend/modules/mera/meraVerimAyarlari.routes');
...
app.use('/api/mera-verim-ayarlari', meraVerimAyarlariRoutes);
